...
abstract class Mage_Core_Block_Abstract extends Varien_Object
{
    ...
    /**
	 * @todo return Request object (if exists in the FW)
...
//        return $this->_request;
    ...
    {
        return null; // Mage::app()->getFrontController()->getAction();
    }
...
//                array('block' => $this, 'transport' => self::$_transportObject));
    ...
    {
		throw new Mage_Layout_Exception('Generic getUrl method is not implemented yet');
